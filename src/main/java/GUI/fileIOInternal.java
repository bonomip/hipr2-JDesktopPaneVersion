...
public class fileIOInternal {
   ...
   */
  public fileIOInternal(ArrayList boxes, linkData links, JInternalFrame frame){
    this.boxes = boxes;
    this.links = links;
    this.frame = frame;
...
//System.out.println("IO 1: "+fileIOdocbase);
	        newOp = new imageLoad(links.getPanel(),links);
