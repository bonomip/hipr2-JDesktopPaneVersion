...
import net.joshuahughes.hipr2.upper.HistEqualize;


public class equalize extends operator1DInt implements Serializable{

  /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
HistEqualize equalizeOp = new HistEqualize();
  static int number=0;
  String type = new String("HistogramEqualizing");

  public equalize(){
  }

  public equalize(JPanel panel, linkData links){
    ++number;
  ...
  public void go(){
    ...
    System.out.println(name);
      ...
      input1.getHeight(),
      imageConversions.pix2gs(equalizeOp.equalize(imageConversions.gs2pix(input1.getValues()),input1.getWidth(),input1.getHeight())));
