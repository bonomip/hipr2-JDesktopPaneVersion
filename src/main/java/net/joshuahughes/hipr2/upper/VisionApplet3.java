...
/**
 *
 *VisionApplet3 is a subclass of the JApplet class which is tailored
 *for use in the HIPR application. It is used with operators which 
 *only require the use of one input image, but which produce two outputs.  
 *
 *@author Timothy Sharman
 */

public class VisionApplet3 extends JApplet implements Serializable{ 
...
//The main window
   ...
   */
  public JLabel output = new JLabel("Output 1");
  /**
   *The second output image label
   */
  public JLabel output2 = new JLabel("Output 2");
  /**
   ...
   */
  public JLabel outsize1 = new JLabel();
  /**
   *The second output image size
   */
  public JLabel outsize2 = new JLabel();
   ...
   */
  public JLabel bmPosition = new JLabel("Point X:  Y: ");
   ...
   */
  public JLabel bmIntensity = new JLabel("Intensity: ");
   ...
   */
  public PixelListener bmpl = new PixelListener();
  /**
  ...
  public void set_image() {
    ...
    dest_canvas2 = new ImageCanvas(src);
  ...
  public void set_interface(){
    ...
    brc. gridx = 0;
    brc. gridy = 0;
    brlayout. setConstraints(output2, brc);
    br. add(output2);

    brc. gridx = 0;
    brc. gridy = 2;
    brlayout. setConstraints(outsize2, brc);
    ...
    bmc. gridx = 0;
    bmc. gridy = 0;
    bmlayout. setConstraints(output, bmc);
    bm. add(output);

    bmc. gridx = 0;
    bmc. gridy = 2;
    bmlayout. setConstraints(outsize1, bmc);
    outsize1. setText(d_w+" x "+d_h);
    bm. add(outsize1);

    bmc. gridx = 0;
    bmc. gridy = 3;
    bmlayout. setConstraints(bmPosition, bmc);
    bm. add(bmPosition);

    bmc. gridx = 0;
    bmc. gridy = 4;
    bmlayout. setConstraints(bmIntensity, bmc);
    bm. add(bmIntensity);
   ...
   public class PixelListener extends MouseMotionAdapter {
	...
	if((actualx < 0) || (actualy < 0)){
	  ...
	  if(ic == dest_canvas){
	    ...
	    bmPosition. setText("Point X:"+actualx+"  Y:"+actualy);
	    bmIntensity. setText("Intensity:"+intense);	
	  }
	  if(ic == dest_canvas2){
	    int intense = dest_1d2[actualx+(actualy*image_width)] & 0x000000ff;
  ...
  public void set_src_image2(int [] input_img , int w, int h, String name) {
    ...
    bmPosition. setText("Point X:  Y: ");
    brPosition. setText("Point X:  Y: ");
    blIntensity. setText("Intensity: ");
    bmIntensity. setText("Intensity: ");
   ...
   *@param input_img The input image array
   *@param w The image width
   *@param h The image height
   *@param name The image name
   */
